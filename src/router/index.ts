    ...
    children: [
      {
        name: 'dashboard',
        path: 'dashboard',
        component: () => import('@/pages/admin/empleados/lista.vue'),
      },
      {
        name: 'nuevo',
        path: 'nuevo',
        component: () => import('@/pages/admin/empleados/nuevo.vue'),
      },
      {
        name: 'editar',
        path: 'editar',
        component: () => import('@/pages/admin/empleados/editar.vue'),
      },
      // {
      //   name: 'datatable',
      //   path: 'datatable',
      //   component: () => import('@/pages/admin/dashboard/JqueryTable.vue'),
      // },
      UIRoute,
    ]
  },
